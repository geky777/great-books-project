...
h1 {
  ...
  .project-card {
    ...
    text-align: center;
    opacity: 0;
    transform: scale(0.7) translateY(-20px) rotateY(10deg) rotateZ(-2deg);
    transition: transform 0.9s cubic-bezier(0.68,-0.55,0.27,1.55), 
                box-shadow 0.4s ease, 
                opacity 0.6s ease;
  ...
  .project-container.active .side.right3 {
    transform: translateX(840px) scale(1) rotateY(-28deg) rotateZ(5deg);
    opacity: 1; pointer-events: auto;
  }
